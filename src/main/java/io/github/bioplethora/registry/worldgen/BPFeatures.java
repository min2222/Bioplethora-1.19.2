...
public class BPFeatures {
    ...
    public static final RegistryObject<Feature<RandomPatchConfiguration>> LAVA_EDGE_CLUSTER = FEATURES.register("lava_edge_cluster", () -> new LavaEdgeClusterFeature(RandomPatchConfiguration.CODEC.stable()));
    ...
    public static final RegistryObject<Feature<BlockPileConfiguration>> SINGULAR_BLOCK = FEATURES.register("singular_block", () -> new SingularBlockFeature(BlockPileConfiguration.CODEC));
    ...
    public static final RegistryObject<Feature<DeltaFeatureConfiguration>> END_LAND_SPONGE = FEATURES.register("end_land_sponge", () -> new EndLandsSpongeFeature(DeltaFeatureConfiguration.CODEC));
    ...
    public static final RegistryObject<Feature<BlockStateConfiguration>> WATER_PLANT = FEATURES.register("water_plant", () -> new WaterPlantFeature(BlockStateConfiguration.CODEC));
    ...
    public static final RegistryObject<Feature<ProbabilityFeatureConfiguration>> CORSASCILE = FEATURES.register("corsascile", () -> new CorsascileFeature(ProbabilityFeatureConfiguration.CODEC));
