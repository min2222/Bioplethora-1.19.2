...
public class ClientUtils {
    ...
    public static void renderRotatedParticle(TextureSheetParticle particle, VertexConsumer vertexBuilder, Camera activeRenderInfo, float partialTicks, Consumer<Quaternionf> consumer) {
        ...
        Quaternionf quaternion = new Quaternionf().setAngleAxis(Math.toRadians(0.0F), ROTATION_VECTOR.x, ROTATION_VECTOR.y, ROTATION_VECTOR.z);
        consumer.accept(quaternion);
        TRANSFORM_VECTOR.rotate(quaternion);
