...
public class GrylynenCoreBombRender extends GeoEntityRenderer<GrylynenCoreBombEntity> {
    ...
    @Override
    public RenderType getRenderType(GrylynenCoreBombEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
    ...
    @Override
    public void renderEarly(GrylynenCoreBombEntity animatable, PoseStack stackIn, float ticks, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float partialTicks) {
