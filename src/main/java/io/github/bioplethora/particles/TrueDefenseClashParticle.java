...
@OnlyIn(Dist.CLIENT)
public class TrueDefenseClashParticle extends TextureSheetParticle {

    private final SpriteSet sprites;

    private TrueDefenseClashParticle(ClientLevel clientLevel, double p_i232384_2_, double p_i232384_4_, double p_i232384_6_, double p_i232384_8_, double p_i232384_10_, double p_i232384_12_, SpriteSet sprite) {
